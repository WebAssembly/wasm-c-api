(module
  ...
  (func (export "set var f32 import") (param f32) (set_global $mut_f32_import (get_local 0)))
  (func (export "set var i64 import") (param f64) (set_global $mut_i64_import (i64.reinterpret/f64 (get_local 0))))

  (func (export "set var f32 export") (param f32) (set_global $mut_f32_export (get_local 0)))
