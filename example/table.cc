...
auto neg_callback(const wasm::Val args[], wasm::Val results[])
    -> wasm::own<wasm::Trap> {
...
auto call(const wasm::Func* func, wasm::Val&& arg1, wasm::Val&& arg2)
    -> wasm::Val {
...
void run() {
  ...
  auto tabletype = wasm::TableType::make(wasm::ValType::make(wasm::FUNCREF),
                                         wasm::Limits(5, 5));
